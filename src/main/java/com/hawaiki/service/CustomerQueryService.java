...
import com.hawaiki.domain.Customer;
import com.hawaiki.domain.*; // for static metamodels
import com.hawaiki.repository.CustomerRepository;
import com.hawaiki.service.dto.CustomerCriteria;
    ...
    private Specifications<Customer> createSpecification(CustomerCriteria criteria) {
        ...
        if (criteria != null) {
            ...
            if (criteria.getLicenseid() != null) {
                specification = specification.and(buildRangeSpecification(criteria.getLicenseid(), Customer_.licenseid));
            }
        }
