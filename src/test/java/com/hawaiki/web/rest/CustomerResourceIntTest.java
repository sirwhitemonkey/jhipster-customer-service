...
public class CustomerResourceIntTest {
    ...
    private static final Integer DEFAULT_LICENSEID = 1;
    private static final Integer UPDATED_LICENSEID = 2;
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getLicenseid()).isEqualTo(DEFAULT_LICENSEID);
    }
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.licenseid").value(DEFAULT_LICENSEID));
    }
    ...
    @Test
    @Transactional
    public void getAllCustomersByLicenseidIsEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where licenseid equals to DEFAULT_LICENSEID
        defaultCustomerShouldBeFound("licenseid.equals=" + DEFAULT_LICENSEID);

        // Get all the customerList where licenseid equals to UPDATED_LICENSEID
        defaultCustomerShouldNotBeFound("licenseid.equals=" + UPDATED_LICENSEID);
    }

    @Test
    @Transactional
    public void getAllCustomersByLicenseidIsInShouldWork() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where licenseid in DEFAULT_LICENSEID or UPDATED_LICENSEID
        defaultCustomerShouldBeFound("licenseid.in=" + DEFAULT_LICENSEID + "," + UPDATED_LICENSEID);

        // Get all the customerList where licenseid equals to UPDATED_LICENSEID
        defaultCustomerShouldNotBeFound("licenseid.in=" + UPDATED_LICENSEID);
    }

    @Test
    @Transactional
    public void getAllCustomersByLicenseidIsNullOrNotNull() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where licenseid is not null
        defaultCustomerShouldBeFound("licenseid.specified=true");

        // Get all the customerList where licenseid is null
        defaultCustomerShouldNotBeFound("licenseid.specified=false");
    }

    @Test
    @Transactional
    public void getAllCustomersByLicenseidIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where licenseid greater than or equals to DEFAULT_LICENSEID
        defaultCustomerShouldBeFound("licenseid.greaterOrEqualThan=" + DEFAULT_LICENSEID);

        // Get all the customerList where licenseid greater than or equals to UPDATED_LICENSEID
        defaultCustomerShouldNotBeFound("licenseid.greaterOrEqualThan=" + UPDATED_LICENSEID);
    }

    @Test
    @Transactional
    public void getAllCustomersByLicenseidIsLessThanSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where licenseid less than or equals to DEFAULT_LICENSEID
        defaultCustomerShouldNotBeFound("licenseid.lessThan=" + DEFAULT_LICENSEID);

        // Get all the customerList where licenseid less than or equals to UPDATED_LICENSEID
        defaultCustomerShouldBeFound("licenseid.lessThan=" + UPDATED_LICENSEID);
    }
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getLicenseid()).isEqualTo(UPDATED_LICENSEID);
    }
